# Generated by Django 3.2.12 on 2026-05-07 16:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency",
                    models.CharField(blank=True, default="RUB", max_length=10),
                ),
            ],
            options={
                "abstract": False,
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="marketplace_management.oidcaccesstoken",
                    ),
                ),
                (
                    "client",
                    models.ForeignKey(
                        ...
                        to="marketplace_management.oidcclient",
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="oidc_refresh_tokens",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="oidc_access_tokens",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="installations",
                        to="marketplace_management.payment",
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="apps", to="marketplace_management.Category"
            ),
        ),
    ]
